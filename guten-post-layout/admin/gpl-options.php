            ...
            <div class="gpl-welcome-container">
                <div class="gpl-welcome-tab gpl-panel-contain">
                    <h2 class="nav-tab-wrapper">
                        <a class="nav-tab nav-tab-active nav-tab-link" data-tab-id="en-dashboard" href="#"><?php echo esc_html__( 'Dashboard', 'guten-post-layout' ); ?></a>
                        <a class="nav-tab nav-tab-link" data-tab-id="en-help" href="#"><?php echo esc_html__( 'Help', 'guten-post-layout' ); ?></a>
                        <a class="nav-tab nav-tab-link" data-tab-id="en-review" href="#"><?php echo esc_html__( 'Review', 'guten-post-layout' ); ?></a>
                    </h2>
                    <div class="gpl-wrapper">
                        ...
                        <div class="nav-tab-content panel_open" id="en-dashboard">
                            ...
                            <div class="gpl-cta-wrapper">
                                <a href="<?php echo esc_url(admin_url()) . '/post-new.php?post_type=page'?>" class="button button-primary button-large">Create Your First Layout</a>
                            ...
                            <div class="gpl-section">
                                <div class="gpl-row en-mt-minus">
                                    ...
                                    <div class="gpl-columns-1">
                                        <img class="gpl-block-help-image" src="<?php echo esc_url(plugins_url( 'admin/img/help-service.png', dirname( __FILE__ )));?>"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="nav-tab-content" id="en-review">
                            <div class="gpl-section">
                                ...
                                <p class="gpl-review-description"> We hope you are enjoying Guten Post Layout? Can you please leave us a <a href="https://wordpress.org/support/plugin/guten-post-layout/reviews/" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating. It will take less than one minute. We really look forward to getting your reviews which is super helpful to improve your beloved Guten Post Layout</p>
                                    ...
                                    <div class="gpl-columns-1">
                                        <img class="gpl-block-review-image" src="<?php echo esc_url(plugins_url( 'admin/img/review.png', dirname( __FILE__ )));?>"/>
                                    </div>
                            </div>
                        </div>
                    </div>
