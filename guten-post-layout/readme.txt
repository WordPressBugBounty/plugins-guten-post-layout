...
Tags: Gutenberg blocks, grid layout, post blocks, block plugin, post layout plugin
...
== Changelog ==
= 1.2.6 =
- Security: Nonce Verification fixed for posts filter REQUEST

= 1.2.5 =
- Fixes vulnerability in align attribute for attacker with Contributor level access reported by WordFence
- Fix WordPress 6.6 Compatibility
- Fix attributes and settings sanitization & escaping
